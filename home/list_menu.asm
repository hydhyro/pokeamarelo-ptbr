...
; the code up to .skipMovingSprites appears to be useless
	hlcoord 1, 2 ; coordinates of upper left corner of menu text box
...
.setMenuVariables
	...
	ld a, 4
	ld [wTopMenuItemY], a
	ld a, 1;posição do primeiro cursor do menu
	ld [wTopMenuItemX], a
...
PrintListMenuEntries::
	hlcoord 1, 3 ;inventário original 5,3
	lb bc, 9, 18;14 hyd alt
...
.skipMultiplying
	...
	inc d
.noCarry
	hlcoord 2, 4 ; coordinates of first list entry name
...
.printItemPrice
	...
	pop hl
	ld bc, SCREEN_WIDTH + 10 ; 1 row down and 5 columns right
	add hl, bc
...
.skipCopyingLevel
	pop hl
	ld bc, $0a;posição do nível level dos pokémons na lista do PC
	add hl, bc
	call PrintLevel
	pop af
	ld [wd11e], a
...
.printItemQuantity
	...
	push hl
	ld bc, 14;origina =SCREEN_WIDTH + 8 ; 1 row down and 8 columns right posição da quantidade
	add hl, bc
	ld a, "×"
	ld [hli], a
	ld a, [wd11e]
