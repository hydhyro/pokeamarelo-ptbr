...
; Fuchsia Gym
	...
	db 34, DROWZEE, HYPNO, 0;esse foi removido em troca de AYA
; Victory Road 2F
	db 48, MR_MIME, 0
; Unused
	db 33, HYPNO, 0
...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 25, ONIX, 24, CUBONE, 29, PERSIAN, 0
; Silph Co. 11F
	db $FF, 37, NIDORINO, 35, PERSIAN, 37, MAROWAK, 41, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 50, DUGTRIO, 53, PERSIAN, 53, NIDOQUEEN, 55, NIDOKING, 55, KANGASKHAN, 0
...
KogaData:
	db $FF, 44, VOLTORB, 46, VENONAT, 48, GOLBAT, 50, VENOMOTH, 0

BlaineData:
	db $FF, 48, NINETALES, 50, RHYDON, 54, MAGMAR, 0
	;db $FF, 48, NINETALES, 50, RAPIDASH, 54, ARCANINE, 0;original team
