...
DrawSurfingPikachuMinigameIntroBackground:
	...
	ld a, $ff
	call FillMemory
	ld hl, Tilemap_f90bc;background
	decoord 0, 6
	ld bc, 12 * SCREEN_WIDTH
	call CopyData
	ld de, Tilemap_f91c8;logo pikachus beach
	hlcoord 4, 0
	lb bc, 6, 12
	call .CopyBox
	hlcoord 3, 7
	...
	call .FillBoxWithFF
	ld hl, Tilemap_f91ac
	decoord 3, 7;use control pad ; use o controle
	ld bc, 15
	call CopyData
	ld hl, Tilemap_f91bb
	decoord 4, 9;to rad / para surfar
	ld bc, 13
	call CopyData
	ret
