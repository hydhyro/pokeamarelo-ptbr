...
LoadCopyrightTiles:
    ...
    lb bc, BANK(HydRightsgfx), 19 ; number of tiles the graphic takes up horizontally
    call CopyVideoData
...
CopyrightTextString:
	...
	;next $bb,$bc,$bd,$c0,$c1,$c3,$c4,$7F,$c5,$c6,$c7,$c8,$c9,$ca,$cb,$cc,$cd ;Hydrigths
	next $c4,$c5,$c6,$c7,$c8,$cc,$cd,$7F,$bb,$bc,$bd,$be,$bf,$c0,$c1,$c2,$c3
	db   "@"
