...
.Printing:
	...
	next "    IMPRIMINDO...@"
.Error1:
	db   "Erro de Impressã~o1"
	next ""
	next " Confira o Manual"
	next "Game Boy Printer.@"
.Error2:
	db   "Erro de Impressã~o2"
	next ""
	next " Confira o Manual"
	next "Game Boy Printer.@"
.Error3:
	db   "Erro de Impressã~o3"
	next ""
	next " Confira o Manual"
	next "Game Boy Printer.@"
.Error4:
	db   "Erro de Impressã~o4"
	next ""
	next " Confira o Manual"
	next "Game Boy Printer.@"
.WrongDevice:
...
.PokemonListString: db "LISTA DE POKèMON@"
.BoxString: db "CAIXA@"
