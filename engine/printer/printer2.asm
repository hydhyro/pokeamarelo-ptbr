...
.PlaceMoveName:
	...
	jr z, .no_move
	ld [wPokeBallAnimData], a
	call GetAltMoveName;hydalt extra para fanclubprinter
	jr .place_string
...
LoadTREINADORPRINTgfx:; Carrega o gráfico TREINADOR para os ingame Trade Trainer's name
